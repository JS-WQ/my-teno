<template>
  <div class=''>
    <div class="teStarBox">
      ...
      <div class="teStarBanner">
        <div class="wrapper">
          <img :src="starData.topData.img_url">
          <div class="text">
            <h4>{{starData.topData.title_en}}</h4>
            <h2 class="h3-50">{{starData.topData.title}} × MY TENO</h2>
            <div class="btnBox">
              <a @click="showImgs(starData.topData.id)">
                <div
                  class="wrapper"
                  style="background-image: url('../assets/images/png/star-btn.png')"
                >
                  <span>Read</span>
                </div>
              </a>
...
export default {
  ...
  setup() {
    ...
    onUpdated(() => {
      if (pageLoading.value && starData.list.length > 0) {
